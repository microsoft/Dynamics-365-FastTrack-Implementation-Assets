...
/*
 * 	- Update the needed dependecies using Nuget packages
	- If needed - Add the Odata Conencted service extension (https://learn.microsoft.com/en-us/odata/connectedservice/getting-started)
	- Generate the Odata proxy using the Connected service:
...
using Microsoft.Dynamics.DataEntities; //This is available when generated by OData Connected Service
...
namespace ODataCoreConsoleApp
{
    class Program
    {
        ...
        {         
            ...
            var context = new Microsoft.Dynamics.DataEntities.Resources(new Uri($"{config.BaseUrl}/data/"));            
            ...
            Console.WriteLine(custGroupsQuery.ToString());
            try
            {

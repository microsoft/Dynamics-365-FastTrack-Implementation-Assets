...
namespace Microsoft.Dynamics.Commerce.Runtime.Workflow.CartManagement
{
    ...
    /// <summary>
    /// Captcha validation request trigger.
    ...
    /// </summary>
    internal sealed class CaptchaValidationTrigger : IRequestTriggerAsync
    {
        ...
        public IEnumerable<Type> SupportedRequestTypes
        {
            get
            {
                return new[] { typeof(RetrieveCardPaymentAcceptResultServiceRequest) };
            }
        }
        ...
        {
            var retrieveCardPaymentAcceptResultServiceRequest = request as RetrieveCardPaymentAcceptResultServiceRequest;

            // Get cart with cart id.
            CartSearchCriteria cartSearchCriteria = new CartSearchCriteria(retrieveCardPaymentAcceptResultServiceRequest.CartId);
            ...
            if (cart == null)
            {
                ...
                throw new CartValidationException(DataValidationErrors.Microsoft_Dynamics_Commerce_Runtime_CartNotFound, retrieveCardPaymentAcceptResultServiceRequest.CartId);
            }

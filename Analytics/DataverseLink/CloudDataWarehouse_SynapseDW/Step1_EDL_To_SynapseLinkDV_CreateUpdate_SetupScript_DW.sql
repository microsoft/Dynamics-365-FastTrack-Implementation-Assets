...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dvtosql].[target_dedupAndMerge]') AND type in (N'P'))
EXEC('CREATE PROC [dvtosql].target_dedupAndMerge
(

/****** Object:  StoredProcedure [dbo].[UL_CreateProject]    Script Date: 6/9/2022 5:53:45 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[UL_CreateProject]
AS
...
JOIN (
   ...
   FROM
       DL_Account) AS ac
ON
   pr.CustomerName = ac.Name and
   co.msdyn_owningcompany = ac.CompanyId
JOIN (
   SELECT 

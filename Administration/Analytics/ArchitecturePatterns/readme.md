...
2. Create Synapse Workspace and use [CDMUtil](../CDMUtilSolution) to create external table or view for Tables folder and ChangeFeed folders.
...
1. Export Finance and Operations Apps Tables data to Data Lake
2. Deploy [CDM Util](../CDMUtilSolution/deploycdmutil.md) as Function App - this is used to get metadata details directly from the lake 
